...
<div class="bg-white p-6 rounded-lg shadow-lg">
    ...
    <a href="{{ route('barang.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded mt-4 inline-block hover:bg-blue-600 transition duration-200">
        Tambah Barang
    </a>
        ...
        <table class="w-full mt-4 min-w-max">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-100 transition duration-150">
                    ...
                    <td class="px-4 py-2 text-sm md:text-base">Rp {{ number_format($item->harga_barang, 0, ',', '.') }}</td>
